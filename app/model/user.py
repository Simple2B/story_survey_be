...
class User(Base):
    ...
    username = Column(String(628), nullable=True)

    image = Column(String(628), nullable=True)
    email = Column(String(628), nullable=False, unique=True)

    password_hash = Column(String(628), nullable=True)
